...
public class WishController {
    ...
    @Autowired
    public WishController(UserRepository userRepository, ProductRepository productRepository, JwtService jwtService) {
    ...
    @GetMapping("/")
    public ResponseEntity<List<String>> getWishlist(@RequestBody String token) {
